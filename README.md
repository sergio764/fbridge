...
GitHub Pages can serve this folder directly from the repository root. When a custom domain is ready, add a `CNAME` file with that domain and update the GitHub Pages domain settings.
