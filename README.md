...
The first screen should say one thing clearly: FBridge finds ingredient suppliers in Latin America and Africa. Buyers only pay when they move forward with a supplier FBridge found. Keep enough line spacing in the opening headline that Futura's descenders remain visibly clear of the following line at every viewport size.
